# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 15:57:42 2024
...
# Задание стартовых точек
seeds = [(130,315),(75,675),(210,385),(260, 409),(354,394),(154,378),
         (201,299),(276,246),(173,446)]
# координаты для графика
x = list(map(lambda x: x[1], seeds))
y = list(map(lambda x: x[0], seeds))
# Порог похожести цвета региона
threshold = 102
# Нахождение сегментов используя метод region_growingHSV
segmented_region = region_growingHSV(image, seeds, threshold)
